...
hl.bind(secondaryMod .. " + B", hl.dsp.exec_cmd(browser .. " --private-window"))
hl.bind(secondaryMod .. " + Q", hl.dsp.exec_cmd("hyprlock"))
hl.bind("PRINT", hl.dsp.exec_cmd("hyprshot -m output --clipboard-only"))
hl.bind(mainMod .. " + PRINT", hl.dsp.exec_cmd("hyprshot -m window --clipboard-only"))
hl.bind(secondaryMod .. " + PRINT", hl.dsp.exec_cmd("hyprshot -m region --clipboard-only"))
...
hl.bind(secondaryMod .. " + F", hl.dsp.window.float({ action = "toggle" }))
...
hl.bind(secondaryMod .. " + S", hl.dsp.window.move({ workspace = "special:magic" }))
